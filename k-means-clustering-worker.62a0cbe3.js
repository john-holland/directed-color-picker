...
const calculateColorDistance = (color1, color2, method) => {
  switch (method) {
    ...
    case 'hsl-max':
      ...
      const color1HSL = (0,tinycolor2__WEBPACK_IMPORTED_MODULE_2__.default)({ h: color1[0], s: color1[1], v: color1[2] }).toHsl();
      const color2HSL = (0,tinycolor2__WEBPACK_IMPORTED_MODULE_2__.default)({ h: color2[0], s: color2[1], v: color2[2] }).toHsl();
      return hslDistance([color1HSL.h, color1HSL.s, color1HSL.l], [color2HSL.h, color2HSL.s, color2HSL.l]);
    case 'hsl-avg':
      // Convert HSV to HSL for comparison
      const color1HSL_avg = (0,tinycolor2__WEBPACK_IMPORTED_MODULE_2__.default)({ h: color1[0], s: color1[1], v: color1[2] }).toHsl();
      const color2HSL_avg = (0,tinycolor2__WEBPACK_IMPORTED_MODULE_2__.default)({ h: color2[0], s: color2[1], v: color2[2] }).toHsl();
    ...
    case 'max-hsv-hsl':
      ...
      const color1HSL_max = (0,tinycolor2__WEBPACK_IMPORTED_MODULE_2__.default)({ h: color1[0], s: color1[1], v: color1[2] }).toHsl();
...
/******/ })()
;
//# sourceMappingURL=k-means-clustering-worker.62a0cbe3.js.map